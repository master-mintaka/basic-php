      ...
      <table class="min-w-full divide-y divide-gray-200">
        <thead class="bg-gray-50">
          <tr>
            ...
            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">View more</th>
          </tr>
        </thead>
        <tbody class="bg-white divide-y divide-gray-200">
          <?php foreach ($notes as $note) : ?>
            <tr>
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><a href="/note?id=<?= $note['id'] ?>">View more</a></td>
            </tr>
          <?php endforeach; ?>
        </tbody>
      </table>
